...
A single self-contained web page listing 491 sales openings in Chicago and Illinois,
...
|---|---|---|
| `index.html` | The shareable site. 491 roles. No CRM data, no names. | Anyone you send the link to |
...
- **Opening screen.** The page opens on a choice between Stephen and Frank. Each has their
  own set of statuses and star ratings on the same 491 roles, and the card shows a summary
...
- **Postings expire.** Everything was compiled on 10 September 2026, with 52 resume-matched roles and 59 commercial-fit roles added on 11 September. The same day, 77 roles that would have meant relocating from Chicago were removed and roles leaning on industry or technical experience were downgraded. Confirm any role is
